 ...
 * @LastEditTime: 2025-03-05 12:24:33
...
export default function About() {
  return (
    <section className='relative min-h-[600px] flex items-center bg-gradient-to-r from-blue-50 to-blue-100 bg-body-img-services'>
